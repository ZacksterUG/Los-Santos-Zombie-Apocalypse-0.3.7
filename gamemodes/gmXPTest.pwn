...
#define CPTIME                                                          60000//Time between each checkpoint
#define CPVALUE                                                         350//CPValue, the value of, when it gets reached, it the cp gets cleared.
...
public OnGameModeInit()
{
	...
	RoundEnded = 0;
	NZGateOpened = 0;
	NZGate = CreateObject(971, 945.96, -1103.36, 26.73, 0.00, 0.00, 270.68);
	...
	for(new i; i < MAX_PLAYERS;i++)
	{
        ...
        Stats[i] = TextDrawCreate(488.667083, 339.561523, "usebox");
...
{
	SendClientMessage(playerid,red,"Scripter: Firecat");
	SendClientMessage(playerid,red,"Special thanks to: SA-MP Forums, Cyber_Punk");
	return 1;
}
				        ...
				        if(IsPlayerInRangeOfPoint(playerid,1.0,Locations[0][0],Locations[0][1],Locations[0][2]))
				        {
							...
							switch(rand)
							{
							    case 0:
								{
									...
									SetPlayerMapIcon(playerid,1,Locations[2][3],Locations[2][4],Locations[2][5],62,0,MAPICON_GLOBAL);
								}
								case 1:
								{
									...
									MissionPlace[playerid][0] = 4;
								 	MissionPlace[playerid][1] = 2;
								 	SetPlayerMapIcon(playerid,1,Locations[3][3],Locations[3][4],Locations[3][5],62,0,MAPICON_GLOBAL);
								}
							}
				        }
				    }
                        ...
                        if(IsPlayerInRangeOfPoint(playerid,1.0,Locations[2][0],Locations[2][1],Locations[2][2]))
				        {
							...
							switch(rand)
							{
							    case 0:
								{
									...
									SetPlayerMapIcon(playerid,1,Locations[4][3],Locations[4][4],Locations[4][5],62,0,MAPICON_GLOBAL);
								}
								case 1:
								{
									...
									MissionPlace[playerid][1] = 3;
									SetPlayerMapIcon(playerid,1,Locations[5][3],Locations[5][4],Locations[5][5],62,0,MAPICON_GLOBAL);
								}
							}
						}
					}
	...
	for(new i; i < MAX_PLAYERS;i++)
	{
		...
		if(Team[i] == HUMAN)
	    {
		    ...
		    format(string,sizeof string,"XP: %i/%i",PInfo[i][XP],PInfo[i][XPToRankUp]);
	  		PlayerTextDrawSetString(i,XPtextdraw[i][3],string);
			PlayerTextDrawShow(i,XPtextdraw[i][3]);
...
stock CheckRankup(playerid,gw=0)
{
	...
	if(gw == 1)
	{
	    ...
	    switch(PInfo[playerid][Rank])
		{
			...
			case 31: GivePlayerWeapon(playerid,24,700),GivePlayerWeapon(playerid,9,1),GivePlayerWeapon(playerid,26,200),GivePlayerWeapon(playerid,32,150);
			case 32: GivePlayerWeapon(playerid,24,800),GivePlayerWeapon(playerid,9,1),GivePlayerWeapon(playerid,26,250),GivePlayerWeapon(playerid,32,200);
            case 33: GivePlayerWeapon(playerid,24,900),GivePlayerWeapon(playerid,9,1),GivePlayerWeapon(playerid,26,300),GivePlayerWeapon(playerid,32,300);
            case 34: GivePlayerWeapon(playerid,24,1000),GivePlayerWeapon(playerid,9,1),GivePlayerWeapon(playerid,26,400),GivePlayerWeapon(playerid,32,400);
            case 35: GivePlayerWeapon(playerid,24,700),GivePlayerWeapon(playerid,9,1),GivePlayerWeapon(playerid,27,50),GivePlayerWeapon(playerid,32,150);
		}
	}
	SetPlayerScore(playerid,PInfo[playerid][Rank]);
	return 1;
